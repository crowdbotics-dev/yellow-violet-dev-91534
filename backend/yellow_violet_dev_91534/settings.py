"""
Django settings for yellow_violet_dev_91534 project.
...
ROOT_URLCONF = 'yellow_violet_dev_91534.urls'
...
WSGI_APPLICATION = 'yellow_violet_dev_91534.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_violet_dev_91534 API",
    "DESCRIPTION": "API documentation for yellow_violet_dev_91534 App",
    "VERSION": "v1",
}
